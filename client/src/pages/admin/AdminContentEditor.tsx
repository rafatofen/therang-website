...
const PAGE_STRUCTURE: Record<string, { label: string; sections: { key: string; label: string; fields: string[] }[] }> = {
  ...
  location: {
    ...
    sections: [
      ...
      { key: "location.travel", label: "Travel Times", fields: ["title", "body"] },
      { key: "location.favourites", label: "Local Favourites", fields: ["title", "body"] },
    ],
  },
  tour: {
    label: "3D Tour Page",
    sections: [
      ...
      { key: "tour.embed", label: "Matterport Embed", fields: ["body"] },
    ],
  },
  booking: {
    label: "Booking Page",
    sections: [
      ...
      { key: "booking.overview", label: "Villa Overview", fields: ["title", "body"] },
      { key: "booking.services", label: "Services Section", fields: ["title", "imageUrl"] },
