    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[50vh] min-h-[350px] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          <img src={HERO_POOL} alt="The Rang Uluwatu" className="w-full h-full object-cover" />
        ...
        <div className="container relative z-10 pb-12 lg:pb-16">
          ...
          <p className="text-white/60 leading-[1.8] text-[15px] max-w-xl mt-4">
            Explore every corner of The Rang from the comfort of your screen.
          </p>
        </div>
      </section>
      ...
      <section className="bg-black">
        <div className="w-full" style={{ height: "75vh", minHeight: "500px" }}>
          <iframe
            src="https://my.matterport.com/show/?m=iSm1iF9KDNC"
            width="100%"
            height="100%"
            frameBorder="0"
            allowFullScreen
